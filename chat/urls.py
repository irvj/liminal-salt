...
urlpatterns = [
    ...
    path('session/thread-memory/settings/save/', views.save_thread_memory_settings, name='save_thread_memory_settings'),
    path('session/thread-memory/settings/reset/', views.reset_thread_memory_settings, name='reset_thread_memory_settings'),
    ...
    path('context/local/browse/', views.browse_directories, name='browse_directories'),
    path('context/local/add/', views.add_local_context_dir, name='add_local_context_dir'),
    path('context/local/remove/', views.remove_local_context_dir, name='remove_local_context_dir'),
    path('context/local/toggle/', views.toggle_local_context_file, name='toggle_local_context_file'),
    path('context/local/content/', views.get_local_context_file_content, name='get_local_context_file_content'),
    path('context/local/refresh/', views.refresh_local_context_dir, name='refresh_local_context_dir'),
    path('settings/context/upload/', views.upload_context_file, name='upload_context_file'),
    path('settings/context/delete/', views.delete_context_file, name='delete_context_file'),
    path('settings/context/toggle/', views.toggle_context_file, name='toggle_context_file'),
    path('settings/context/content/', views.get_context_file_content, name='get_context_file_content'),
    path('settings/context/save/', views.save_context_file_content, name='save_context_file_content'),
